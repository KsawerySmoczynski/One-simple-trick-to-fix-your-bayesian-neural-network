...
from pyro.optim.pytorch_optimizers import Adam, SGD
...
def prepare_loaders(x, y, b_size):
    train_loader = DataLoader(
        dataset=x, batch_size=b_size, shuffle=True, num_workers=2, pin_memory=True, prefetch_factor=2
    )
    test_loader = DataLoader(
        dataset=y, batch_size=b_size, shuffle=True, num_workers=2, pin_memory=True, prefetch_factor=2
    )
