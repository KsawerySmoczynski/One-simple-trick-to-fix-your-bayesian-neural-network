...
class MNIST(DataModule):
    def __init__(
        ...
        # self.train_dataset.data = self.train_dataset.data[:5000]
        # self.train_dataset.targets = self.train_dataset.targets[:5000]
        # self.test_dataset.data = self.test_dataset.data[:1000]
        # self.test_dataset.targets = self.test_dataset.targets[:1000]
