# source: https://github.com/xapharius/pytorch-nyuv2
...
class NYUv2Dataset(Dataset):
    ...
    def __init__(
        ...
        #     with Image.open(os.path.join(folder("rgb"), self._files[index])) as img:
        #         self.rgb_images.append(t(img))
        #     with Image.open(os.path.join(folder("depth"), self._files[index])) as img:
        #         self.depth_values.append(t(img))
